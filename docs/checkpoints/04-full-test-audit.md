...
Branch: `main`
Commit: `9873be5fd1fd28fd270b7763ff4bbd70dd215c1d`
Node: `v20.20.2`
npm: `10.8.2`
...
# skipped 0
# todo 0
# duration_ms 64.34457
```
- FAIL `test/v126-clean-renderer-migration.test.js`
```text
TAP version 13
# Subtest: clean renderer source exists and legacy injected renderer files are absent
ok 1 - clean renderer source exists and legacy injected renderer files are absent
  ---
  duration_ms: 1.633687
  ...
# Subtest: native publishing controls replace legacy print labels
ok 2 - native publishing controls replace legacy print labels
  ---
  duration_ms: 3.631412
  ...
# Subtest: staff-safe layout uses structural rows and a scrollable score viewport
ok 3 - staff-safe layout uses structural rows and a scrollable score viewport
  ---
  duration_ms: 0.759135
  ...
# Subtest: docking and publishing are normal renderer modules, not runtime injectors
ok 4 - docking and publishing are normal renderer modules, not runtime injectors
  ---
  duration_ms: 0.396921
  ...
# Subtest: Build 18 identity is consistent in renderer and bootstrap
not ok 5 - Build 18 identity is consistent in renderer and bootstrap
  ---
  duration_ms: 6.527082
  location: '/home/runner/work/Airmonlink-composer-3/Airmonlink-composer-3/test/v126-clean-renderer-migration.test.js:66:1'
  failureType: 'testCodeFailure'
  error: |-
    The input did not match the regular expression /build:\s*18/. Input:
    ...
    '(() => {\n' +
      ...
      "    $$('[data-dock-tab]').forEach(button => button.addEventListener('click', () => activateRightPanel(button.datas"... 262263 more characters
  ...
  operator: 'match'
  stack: |-
    TestContext.<anonymous> (/home/runner/work/Airmonlink-composer-3/Airmonlink-composer-3/test/v126-clean-renderer-migration.test.js:75:10)
    Test.runInAsyncScope (node:async_hooks:206:9)
    Test.run (node:internal/test_runner/test:796:25)
    Test.processPendingSubtests (node:internal/test_runner/test:526:18)
    Test.postRun (node:internal/test_runner/test:889:19)
...
# skipped 0
# todo 0
# duration_ms 72.170745
```

## Summary

- Passing test files: `25`
